...
namespace ShoppingWeb.Services.Interface
{
    public interface IProductService
    {
        ...
        public Task<IEnumerable<ProductListItemResponseDto>> GetProductAdvancedAsync(string? search, string? brand, string? category, string? sortBy, int pageIndex, int pageSize);
